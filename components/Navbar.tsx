...
import {
  ...
  FiHeart, FiSearch, FiStar, FiBookOpen
} from 'react-icons/fi';
import { useAuth } from '@/context/AuthContext';
import { useCart } from '@/context/CartContext';

// --- NavbarContent: Isme aapka saara logic aur design hai ---
            ...
            <nav className="p-4 space-y-1">
              ...
              <div>
                ...
                {mobilePagesOpen && (
                  <div className="ml-9 mt-1 space-y-1 border-l-2 border-[#10B981]/20">
                    <Link href="/about" className="block p-2 text-sm text-gray-600">About Us</Link>
                    <Link href="/faq" className="block p-2 text-sm text-gray-600">FAQ</Link>
                  </div>
                )}
              </div>
              ...
              {!isUser && (
                <div className="grid grid-cols-2 gap-2 mt-4">
                  <Link href="/login" className="text-center py-2 bg-gray-100 rounded-lg text-xs font-bold">Login</Link>
                  <Link href="/signup" className="text-center py-2 bg-[#10B981] text-white rounded-lg text-xs font-bold">Register</Link>
                </div>
              )}
            </nav>
          </div>
...
// --- Final Export: Isme Suspense hai jo Vercel build ko pass karega ---
