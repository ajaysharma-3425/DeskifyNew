  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] text-slate-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="max-w-4xl">
            ...
            >
              ...
              <span className="text-emerald-400 font-bold tracking-[0.2em] uppercase text-xs">Since 2024</span>
            </motion.div>
            ...
            <motion.p 
              ...
              className="text-lg md:text-2xl text-slate-400 max-w-2xl leading-relaxed mb-10"
            >
            ...
            >
              <Link href="/product" className="group flex items-center gap-3 bg-emerald-500 hover:bg-emerald-400 text-slate-900 px-8 py-4 rounded-2xl font-bold transition-all hover:scale-105">
              ...
              <div className="flex items-center gap-4 px-6 py-4 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md">
                ...
                <span className="text-white text-sm font-medium">Trusted by 10k+ innovators</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="relative">
            ...
            <motion.div 
              whileHover={{ rotate: 5 }}
              className="z-10 absolute -bottom-8 -right-8 bg-white p-6 rounded-3xl shadow-xl border border-slate-100 flex items-center gap-4"
            >
              ...
              <div>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Global Excellence</p>
                <p className="text-lg font-black text-slate-900">Award 2025</p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-slate-600 text-lg leading-relaxed">
              ...
              <p>
                Today, we operate with a core focus on mechanical integrity and user-centric design. Every product in our catalog undergoes 12 stages of quality verification before it reaches your door.
              </p>
            </div>
            <div className="pt-6 border-t border-slate-100 grid grid-cols-2 gap-6">
              <div>
                <p className="text-2xl font-black text-slate-900">01.</p>
                <p className="text-sm font-bold text-slate-400 uppercase">Handpicked Vendors</p>
              </div>
              <div>
                <p className="text-2xl font-black text-slate-900">02.</p>
                <p className="text-sm font-bold text-slate-400 uppercase">Eco-Packaging</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {milestones.map((m, i) => (
              <div key={i} className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm hover:shadow-xl transition-all group">
                ...
                <p className="text-xs font-bold text-slate-400 uppercase mb-2">{m.year}</p>
                <h4 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-emerald-600 transition-colors">{m.title}</h4>
      ...
      <section className="max-w-7xl mx-auto px-6 py-32">
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mt-4 mb-6">WHAT WE STAND FOR</h2>
            <p className="text-slate-500 text-lg">We don't just sell; we advocate for the end user in every decision we make.</p>
          </div>
          <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6">
            {values.map((v, i) => (
              <div key={i} className="p-8 rounded-3xl bg-white border border-slate-100 shadow-sm hover:border-emerald-200 transition-all group">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-7xl mx-auto bg-[#0F172A] rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden">
          ...
          <Link href="/product" className="relative z-10 inline-flex items-center gap-3 bg-white text-slate-900 px-10 py-5 rounded-full font-bold text-lg hover:bg-emerald-400 hover:scale-105 transition-all">
...
function StatCard({ icon, label, value, color }: any) {
  return (
    <div className="bg-white p-6 rounded-3xl shadow-xl border border-slate-100 flex flex-col items-center text-center group hover:-translate-y-2 transition-all">
